...
class RejectChangeRequest(betterproto.Message):
    """The PCI field shall contain the old PCI, not the newly proposed PCI."""
...
class PciServiceStub(betterproto.ServiceStub):
    ...
    async def subscribe(
        self,
        *,
        ncgi_set: Optional[List[int]] = None,
        ...
        async for response in self._unary_stream(
            "/com.airhopcomm.eson.nr.pci.v1.PciService/Subscribe", request, Message,
        ):
            yield response
    ...
    async def retrieve_proposed_changes(
        ...
        ConfirmChange or RejectChange later to indicate to the eSON server
        whether the proposed changes are applied. This RPC may take several
        minutes (the current default is 5 minutes) to complete.
        """
