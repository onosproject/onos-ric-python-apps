...
# sources: lte_registration.proto
...
class RemoveNeighborRequest(betterproto.Message):
    ecgi: int = betterproto.fixed64_field(1)
    neighbor_ecgis: List[int] = betterproto.fixed64_field(2)
...
class RegistrationServiceStub(betterproto.ServiceStub):
    ...
    async def unregister(self, *, ecgi: int = 0) -> "UnregisterResponse":
        """
    ...
    async def add_neighbor(
        self, *, ecgi: int = 0, neighbors: Optional[List["__v1__.Neighbor"]] = None
    ) -> "AddNeighborResponse":
        """
    ...
    async def remove_neighbor(
        self, *, ecgi: int = 0, neighbor_ecgis: Optional[List[int]] = None
        ...
        neighbor_ecgis = neighbor_ecgis or []

        request = RemoveNeighborRequest()
        request.ecgi = ecgi
        request.neighbor_ecgis = neighbor_ecgis
