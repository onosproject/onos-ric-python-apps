...
async def subscribe(
    ...
    for idx, cell in enumerate(
        ...
        format1 = E2SmKpmActionDefinitionFormat1(
        ...
        action_def.action_definition_formats.action_definition_format1 = format1
        action_payload = bytes(action_def)
        logging.warning("format is %s", action_def)
        action = Action(
            id=idx,
